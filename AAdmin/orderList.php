...
<head>
  ...
  <link rel="stylesheet" href="orderList.scss">
    ...
    <table style="width:70%">
        <form action="" method="POST">
            ...
            <div style="margin-right:50%">
                ...
                <select  name="Status" id="">---Select an option ----
                ...
                <input type="submit" name="Statuaas"  value="SUBMIT">
            </div>
...
<?php
          ...
          if(isset($_POST['Statuaas']))
                     {
                      $Status=$_POST['Status'];
                      
                                  $slno=1;
                                      $result=mysqli_query($con,"select * from bookeddetails where Status='$Status'");
        ...
        <div class="product-image">
            <img name="Image"  src="./image/<?php echo $row['Image']; ?>" alt="Placholder Image 2" style=" border: 1px solid #aaa;width: 110%;height:20%;">
          </div>
